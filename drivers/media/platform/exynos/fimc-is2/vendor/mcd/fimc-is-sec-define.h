...
struct fimc_is_from_info {
	...
	u32		crosstalk_cal_data_start_addr;
	u32		crosstalk_cal_data_end_addr;
#endif
...
#if defined(CAMERA_FRONT2)
	char		crosstalk_cal_data_ver[FIMC_IS_CROSSTALK_CAL_DATA_VER_SIZE + 1];
	char		awb2_ver[FIMC_IS_AWB_VER_SIZE + 1];
	char		shading2_ver[FIMC_IS_SHADING_VER_SIZE + 1];
	u32		crosstalk_cal_section_crc_addr;
